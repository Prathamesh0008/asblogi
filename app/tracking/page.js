          ...
          <div className="container relative mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 md:py-20">
            <div className="max-w-4xl mx-auto text-center">
              <div className="inline-flex items-center justify-center px-4 py-2 bg-gradient-to-r from-[#FAB045]/20 to-[#A0A1A2]/20 rounded-full backdrop-blur-sm mb-6">
                <FaGlobe className="mr-2 text-[#FAB045] text-sm sm:text-base" />
                <span className="text-xs sm:text-sm font-semibold">GLOBAL TRACKING NETWORK</span>
              </div>
              
              <h1 className="text-xl sm:text-3xl md:text-5xl font-light mb-4 sm:mb-5 leading-snug tracking-wide text-white/70">
                Track{" "}
                <span className="bg-gradient-to-r from-[#FAB045]/80 to-orange-300/80 bg-clip-text text-transparent">
                  Shipments
                </span>
                <br />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 md:gap-6 max-w-2xl mx-auto mt-8 sm:mt-12 md:mt-16">
                <div className="text-center relative group">
                  ...
                  <div className="relative bg-gradient-to-b from-white/5 to-transparent backdrop-blur-sm rounded-2xl p-4 sm:p-6 border border-white/10">
                    <div className="text-2xl sm:text-3xl font-bold text-[#FAB045] mb-1 sm:mb-2">50k+</div>
                ...
                <div className="text-center relative group">
                  <div className="absolute inset-0 bg-gradient-to-r from-[#FAB045]/5 to-transparent rounded-2xl blur-xl group-hover:blur-2xl transition-all duration-500"></div>
                  <div className="relative bg-gradient-to-b from-white/5 to-transparent backdrop-blur-sm rounded-2xl p-4 sm:p-6 border border-white/10">
                    <div className="text-2xl sm:text-3xl font-bold text-[#FAB045] mb-1 sm:mb-2">90+</div>
                ...
                <div className="text-center relative group">
                  <div className="absolute inset-0 bg-gradient-to-r from-[#FAB045]/5 to-transparent rounded-2xl blur-xl group-hover:blur-2xl transition-all duration-500"></div>
                  <div className="relative bg-gradient-to-b from-white/5 to-transparent backdrop-blur-sm rounded-2xl p-4 sm:p-6 border border-white/10">
                    <div className="text-2xl sm:text-3xl font-bold text-[#FAB045] mb-1 sm:mb-2">99.8%</div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="relative mb-12 sm:mb-16">
                <div className="absolute inset-0 bg-gradient-to-r from-[#FAB045] to-orange-500 rounded-2xl sm:rounded-3xl blur-2xl opacity-20"></div>
                  ...
                  <div className="flex flex-col lg:flex-row items-center justify-between gap-6 sm:gap-8">
                    <div className="flex-1 w-full">
                      <div className="flex items-center mb-4 sm:mb-6">
                        <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-[#FAB045] to-[#f8c468] rounded-xl sm:rounded-2xl flex items-center justify-center mr-3 sm:mr-4 shadow-lg">
                        ...
                        <div>
                          ...
                          <p className="text-gray-500/80 mt-1 sm:mt-2 flex items-center font-light text-xs sm:text-sm">
                            <FaShieldAlt className="mr-2 text-[#FAB045]/80 text-xs" />
                      ...
                      <div className="relative group">
                        <input
                          ...
                          className="w-full pl-12 sm:pl-14 pr-10 sm:pr-12 py-4 sm:py-5 bg-gray-50 border-2 border-gray-200 rounded-xl focus:outline-none focus:border-[#FAB045] focus:ring-4 focus:ring-[#FAB045]/20 transition-all duration-300 text-sm sm:text-base placeholder-gray-400"
                        />
                        <div className="absolute left-3 sm:left-4 top-1/2 transform -translate-y-1/2">
                          <FaBox className="text-[#FAB045] text-base sm:text-xl" />
                        </div>
                      ...
                      <div className="mt-6 sm:mt-8">
                        <p className="text-xs sm:text-sm font-medium text-gray-700 mb-2 sm:mb-3 flex items-center">
                          <FaBell className="mr-2 text-[#FAB045] text-xs sm:text-sm" />
                        ...
                        <div className="flex flex-wrap gap-2 sm:gap-3">
                          {trackingNumbers.map((num) => (
                            <button
                              ...
                              className="px-3 sm:px-4 py-2 sm:py-3 bg-gradient-to-r from-gray-50 to-white border border-gray-200 hover:border-[#FAB045] hover:from-[#FAB045]/5 hover:to-white rounded-lg sm:rounded-xl text-xs sm:text-sm text-gray-700 hover:text-gray-900 font-medium transition-all duration-300 hover:shadow-md group"
                            >
                    ...
                    <button
                      onClick={handleTrack}
                      className="group relative overflow-hidden bg-gradient-to-r from-[#FAB045] to-[#f8c468] hover:from-orange-500 hover:to-[#FAB045] text-white/95 font-semibold py-3 px-6 text-sm sm:text-base transition-all duration-300 hover:shadow-2xl hover:scale-105 flex items-center justify-center shadow-lg w-full lg:w-auto"
                    >
                    ...
                    <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 sm:gap-6">
                      <div className="w-full lg:w-auto">
                        <div className="flex items-center mb-3 sm:mb-4">
                          <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-[#FAB045] to-orange-500 rounded-xl sm:rounded-2xl flex items-center justify-center mr-3 sm:mr-4 shadow-lg">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:space-x-4">
                          <code className="bg-gray-800/50 backdrop-blur-sm px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg sm:rounded-xl font-mono text-[#FAB045] font-bold border border-gray-700 text-xs sm:text-sm break-all">
                            {trackingId}
                          </code>
                      ...
                      <div className="relative group w-full lg:w-auto">
                        <div className="absolute inset-0 bg-gradient-to-r from-[#FAB045] to-orange-500 rounded-xl sm:rounded-2xl blur-xl group-hover:blur-2xl transition-all duration-500"></div>
                ...
                <div className="p-5 sm:p-6 md:p-8 lg:p-10">
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6 mb-8 sm:mb-10">
                    {[
                      ...
                      <div key={index} className="group relative">
                        <div className="absolute inset-0 bg-gradient-to-br from-gray-50 to-white rounded-xl sm:rounded-2xl border border-gray-200 group-hover:border-[#FAB045] transition-all duration-300 shadow-sm"></div>
                  ...
                  <div className="mb-10 sm:mb-12">
                    <div className="flex items-center mb-6 sm:mb-8 md:mb-10">
                      <div className="w-10 h-10 sm:w-14 sm:h-14 bg-gradient-to-r from-[#FAB045] to-orange-500 rounded-xl sm:rounded-2xl flex items-center justify-center mr-3 sm:mr-4 shadow-lg">
                    ...
                    <div className="relative">
                      ...
                      <div className="absolute left-3 sm:left-4 md:left-8 top-0 bottom-0 w-1 bg-gradient-to-b from-[#FAB045] via-orange-300 to-gray-200">
                      ...
                      <div className="space-y-5 sm:space-y-6 ml-10 sm:ml-12 md:ml-16">
                        {trackingInfo.history.map((event, index) => (
                          <div key={index} className="relative group">
                            <div className={`absolute -left-10 sm:-left-12 md:-left-16 top-1/2 transform -translate-y-1/2 w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-xl sm:rounded-2xl flex items-center justify-center shadow-lg ${event.completed ? 'bg-gradient-to-r from-[#FAB045] to-orange-500' : 'bg-gradient-to-r from-gray-300 to-gray-400'}`}>
                              {event.completed ? (
                            ...
                            <div className={`rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 transition-all duration-300 group-hover:-translate-y-1 ${event.completed ? 'bg-gradient-to-br from-white to-gray-50 border-l-2 sm:border-l-4 border-[#FAB045]' : 'bg-gradient-to-br from-gray-50/50 to-white/50'}`}>
                              ...
                              <div className="flex items-center text-gray-700 text-xs sm:text-sm">
                                <FaMapMarkerAlt className="mr-2 sm:mr-3 text-[#FAB045] text-xs sm:text-sm" />
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
                    <div className="bg-gradient-to-br from-white to-gray-50 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-gray-200 hover:border-[#FAB045] transition-all duration-300 group hover:shadow-lg">
                      ...
                      <div className="space-y-2 sm:space-y-3">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pt-3 sm:pt-4 mt-3 sm:mt-4 border-t border-gray-100">
                          <button className="text-[#FAB045] font-semibold hover:text-orange-600 transition-colors flex items-center text-xs sm:text-sm">
                      ...
                      <div className="space-y-3 sm:space-y-4">
                        ...
                        <div className="bg-gray-50 rounded-lg p-2 sm:p-3">
                          ...
                          <p className="font-bold text-gray-900 text-xs sm:text-sm flex items-center flex-wrap gap-1">
                            ...
                            <span className="text-[10px] sm:text-xs bg-[#FAB045]/10 text-[#FAB045] px-2 py-0.5 rounded">Express</span>
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-white to-gray-50 rounded-xl sm:rounded-2xl p-4 sm:p-6 border border-gray-200 hover:border-[#FAB045] transition-all duration-300 group hover:shadow-lg">
                      ...
                      <div className="space-y-3 sm:space-y-4">
                        ...
                        <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                          <button className="flex-1 bg-gradient-to-r from-gray-100 to-white border border-gray-200 text-gray-700 font-semibold py-2 sm:py-3 rounded-lg sm:rounded-xl hover:border-[#FAB045] hover:text-[#FAB045] transition-all duration-300 flex items-center justify-center text-xs sm:text-sm">
                ...
                <div className="bg-gradient-to-r from-gray-50 to-white p-4 sm:p-6 border-t border-gray-200">
                  <div className="flex flex-col md:flex-row justify-between items-center gap-4 md:gap-0">
                    <div className="flex items-center w-full md:w-auto justify-center md:justify-start mb-3 md:mb-0">
                      <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-r from-[#FAB045] to-orange-500 rounded-lg sm:rounded-xl flex items-center justify-center mr-2 sm:mr-3">
                      ...
                      <div>
                        ...
                        <p className="text-[#FAB045] font-semibold cursor-pointer hover:underline text-xs sm:text-sm">
                          Contact our support team
                        </p>
                      </div>
                    </div>
                    <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full md:w-auto">
                      <button className="px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-gray-100 to-white border-2 border-gray-200 text-gray-700 font-semibold rounded-lg sm:rounded-xl hover:border-[#FAB045] hover:text-[#FAB045] hover:shadow-lg transition-all duration-300 flex items-center justify-center text-xs sm:text-sm">
                        <FaPrint className="mr-2 text-xs sm:text-sm" />
                        Print Details
                      </button>
                      <button className="px-6 sm:px-8 py-2 sm:py-3 bg-gradient-to-r from-[#FAB045] to-orange-500 text-white/95 font-semibold rounded-lg sm:rounded-xl hover:shadow-xl hover:scale-105 transition-all duration-300 flex items-center justify-center text-xs sm:text-sm group">
      ...
      {showPopup && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/50 backdrop-blur-sm">
          <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl max-w-md w-full mx-auto overflow-hidden animate-fadeIn">
            {/* Header */}
            <div className="bg-gradient-to-r from-[#FAB045] to-[#f8c468] p-5 sm:p-6 text-white/95">
            ...
            <div className="p-5 sm:p-8">
              <div className="text-center mb-5 sm:mb-6">
                <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-r from-[#FAB045] to-[#f8c468] rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
              ...
              <div className="space-y-3 sm:space-y-4">
                <div className="flex items-center p-3 sm:p-4 bg-gray-50 rounded-lg sm:rounded-xl">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#FAB045]/10 rounded-lg flex items-center justify-center mr-3 sm:mr-4">
                    <FaPhone className="text-[#FAB045] text-base sm:text-lg" />
                  </div>
                  <div>
                ...
                <div className="flex items-center p-3 sm:p-4 bg-gray-50 rounded-lg sm:rounded-xl">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#FAB045]/10 rounded-lg flex items-center justify-center mr-3 sm:mr-4">
                    <FaEnvelope className="text-[#FAB045] text-base sm:text-lg" />
                  </div>
                  <div>
            ...
            <div className="px-5 sm:px-8 pb-5 sm:pb-8">
              <button 
                onClick={closePopup}
                className="w-full bg-gradient-to-r from-[#FAB045] to-[#f8c468] hover:from-orange-500 hover:to-[#FAB045] text-white/95 font-semibold py-3 sm:py-4 rounded-lg sm:rounded-xl transition-all duration-300 hover:shadow-lg text-sm sm:text-base"
              >
                Close
              </button>
            </div>
