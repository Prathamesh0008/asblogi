          ...
          <div className="flex justify-between items-center py-3">
            ...
            <div className="flex items-center space-x-3 sm:space-x-4">
              ...
              <button 
                ...
                className="bg-gradient-to-r from-[#ffd700] to-[#ff7a00] hover:from-[#ff7a00] hover:to-[#FFF176] text-white font-semibold py-2 px-3 sm:px-4 rounded-lg transition-all duration-300 hover:shadow-md hover:scale-105 shadow-sm text-xs sm:text-sm whitespace-nowrap"
              > 
                Get Quote
              </button>
